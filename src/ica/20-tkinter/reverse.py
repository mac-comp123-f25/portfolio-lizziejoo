...
class BasicGui:
    def __init__(self):
        self.mainWin = tk.Tk()
        self.mainWin.title("Reverse Text")
        ...
        output_heading_label.grid(row=2, column=0, padx=10, pady=(10, 0))

        self.display_label = tk.Label(self.mainWin, text="", fg="blue")
        self.display_label.grid(row=3, column=0, columnspan=2, padx=10, pady=(0, 10))
